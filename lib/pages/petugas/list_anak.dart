                    ...
                    child: Stack(
                        children: <Widget>[
                          Positioned(
                              ...
                              top: 23,
                              left: 42,
                              child: Text('Hasil pencarian :', textAlign: TextAlign.left, style: TextStyle(
                              ...
                              top: 57,
                              left: 43,
                              child: Text('Nama Ibu : Emilia', textAlign: TextAlign.left, style: TextStyle(
                                                              ...
                                                              child: Stack(
                                                                  children: <Widget>[
                                                                    Positioned(
                                                                        top: 0,
                                                                        left: 0,
                                                                        child: Text('Lulu Faza Kamilah', textAlign: TextAlign.left, style: TextStyle(
                                                                            color: Color.fromRGBO(58, 57, 57, 1),
                                                                            fontFamily: 'Poppins',
                                                                            fontSize: 12,
                                                                            letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                                                                        ...
                                                                        top: 22,
                                                                        left: 0,
                                                                        child: Text('4 thn 8 bln', textAlign: TextAlign.left, style: TextStyle(
                                                                            color: Color.fromRGBO(58, 57, 57, 1),
                                                                            fontFamily: 'Poppins',
                                                                            fontSize: 12,
                                                                            letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                                                              ...
                                                              child: Stack(
                                                                  children: <Widget>[
                                                                    Positioned(
                                                                        ...
                                                                        child: Container(
                                                                            width: 20,
                                                                            height: 22.42424201965332,
                                                                            decoration: BoxDecoration(
                                                                              image : DecorationImage(
                                                                                  image: AssetImage('assets/image/Tableware.png'),
                                                                                  fit: BoxFit.fitWidth
                                                                              ),
                                                                            )
                                                                        )
                                                                        ...
                                                                        top: 22,
                                                                        left: 0,
                                                                        child: Text('MPASI', textAlign: TextAlign.center, style: TextStyle(
                                                                            color: Color.fromRGBO(255, 255, 255, 1),
                                                                            fontFamily: 'Poppins',
                                                                            fontSize: 12,
                                                                            letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                                                                  ...
                                                                  children: <Widget>[
                                                                    Positioned(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            decoration: BoxDecoration(
                                                                              image : DecorationImage(
                                                                                  image: AssetImage('assets/image/Babyapp.png'),
                                                                                  fit: BoxFit.fitWidth
                                                                              ),
                                                                            )
                                                                        )
                                                                        ...
                                                                        top: 22,
                                                                        left: 0,
                                                                        child: Text('KMS', textAlign: TextAlign.center, style: TextStyle(
                                                                            color: Color.fromRGBO(255, 255, 255, 1),
                                                                            fontFamily: 'Poppins',
                                                                            fontSize: 12,
                                                                            letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
                                                                  ...
                                                                  children: <Widget>[
                                                                    Positioned(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            decoration: BoxDecoration(
                                                                              image : DecorationImage(
                                                                                  image: AssetImage('assets/image/Motherroom.png'),
                                                                                  fit: BoxFit.fitWidth
                                                                              ),
                                                                            )
                                                                        )
                                                                        ...
                                                                        top: 22,
                                                                        left: 0,
                                                                        child: Text('Posyandu', textAlign: TextAlign.center, style: TextStyle(
                                                                            color: Color.fromRGBO(255, 255, 255, 1),
                                                                            fontFamily: 'Poppins',
                                                                            fontSize: 12,
                                                                            letterSpacing: 0 /*percentages not used in flutter. defaulting to zero*/,
