...
class _EditIbuPageState extends State<EditIbuPage> {
                      ...
                      Container(
                        ...
                        child: Center(
                          child: DropdownButtonFormField(
                            ...
                            icon: const Icon(Icons.arrow_downward, size: 20,),
                            elevation: 16,
                            hint: Text("Status pernikahanr", style: TextStyle(color: Colors.black38),),
                            style: const TextStyle(color: Colors.black54),
          ...
          child: Container(
            ...
            child: ElevatedButton(
              ...
              onPressed: () {
                ...
                // print('kode posyandu $_kode_posyandu.text');
                IbuPostMode.editIbu(
                    _nikController.text,
  ...
  void _fetchIbu() async {
    ...
    // print(nik);
    final response = await http.get(Uri.parse("${AppConfig.API_ENDPOINT}/showIbu/"+widget.nik));
    ...
    if (response.statusCode == 200) {
      ...
      _kode_posyandu.text = jsonResponse[i]['kode_posyandu'];
